...
int main1(){
    ...
    testCase.runTest(SocialNetworkTest::InitGraph::SmallWorldGraph, 100, 15, 3, 10, 10, std::make_pair(0.05, 0.06), 0.01, std::make_pair(2, 3), 1, std::make_pair(1, 2), 1, "/Users/Wojtek/Desktop/Tests/");
